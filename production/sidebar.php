...
<br>
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                ...
                <a href="profil.php"><h2><?php echo $_SESSION['kullanici_adi'] ?></h2></a>
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="yem.php"><i class="fa fa-archive"></i> Yemler </a>
                  </li>
                  <li><a href="muhasebe.php"><i class="fa fa-money"></i> Muhasebe </a>
                  </li>
                  <li><a><i class="fa fa-cogs"></i> Ayarlar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="yemler.php">Yemler</a></li>
                      <li><a href="birimler.php">Birimler</a></li>
                      <li><a href="#">Irklar</a></li>
                    </ul>
                  </li>
